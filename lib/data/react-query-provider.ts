 ...
 *
 * This file is the only place in the codebase that directly imports from @tanstack/react-query
 * All other files should use the business logic hooks or the generic provider interface
 */
...
/**
 * Direct export of the provider functions for convenience
 * These are the main exports that business logic hooks should use
 */
