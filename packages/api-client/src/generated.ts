...
export interface paths {
    ...
    "/v1/friends/suggestions": {
        ...
        /** Get friend suggestions from shared groups */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/v1/groups/{id}/join-requests/mine": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/groups/join-requests/incoming": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/groups/join-requests/{requestId}/accept": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/groups/join-requests/{requestId}/decline": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/groups/invitations/incoming": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List group invitations addressed to you */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/v1/groups/invitations/{invitationId}/accept": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/groups/invitations/{invitationId}/decline": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/groups/invitations/{invitationId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        post?: never;
        /** Withdraw a group invitation you sent */
        delete: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/v1/groups/{id}/invitable-users": {
        ...
        /**
         * Search people you could invite to a group
                    ...
                    content: {
                        "application/json": {
                            data: {
                                ...
                                avatarUrl: string | null;
                                /** @enum {string} */
                                invitationStatus: "none" | "invited" | "member" | "requested";
                                /** Format: uuid */
    ...
    "/v1/admin/location/sessions": {
        ...
        /**
         * List all active location sessions (admin)
         * @description Retrieves all active location sessions with user and festival information. Admin only.
         */
        get: {
            parameters: {
                query?: {
    ...
    "/v1/admin/location/sessions/{id}": {
        ...
        post?: never;
        /**
         * Force stop a location session (admin)
    ...
    "/v1/admin/location/sessions/cleanup": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Cleanup expired location sessions (admin)
    ...
    "/v1/photos/{photoId}/reactions": {
        ...
        /**
         * Get reactions for a photo in a group
    ...
    "/v1/photos/{photoId}/comments": {
        ...
        /**
         * Get comments for a photo in a group
         * @description Returns comments for a photo within a specific group context, ordered by creation time
         */
        get: {
            parameters: {
                query: {
    ...
    "/v1/photos/{photoId}/comments/{commentId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/feedback/prompt": {
        ...
        /** Get the day feedback prompt, if one is due */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/v1/feedback": {
        ...
        post: {
            ...
            responses: {
                ...
                /** @description Invalid body, or no drinks logged on that day */
                400: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description Too many bug reports and ideas today */
                429: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/v1/feedback/prompt/dismiss": {
        ...
        get?: never;
        put?: never;
        /** Dismiss the day feedback prompt */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/v1/admin/users": {
        ...
        /**
         * List users (admin)
         * @description Lists users with their profiles, optionally filtered by email, username or full name.
         */
        get: {
            parameters: {
                query?: {
    ...
    "/v1/admin/users/{userId}/auth": {
        ...
        head?: never;
        /**
         * Update a user's email or password (admin)
    ...
    "/v1/admin/users/{userId}/attendances": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * List a user's attendances (admin)
    ...
    "/v1/admin/festivals/{festivalId}/tents": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Add a tent to a festival (admin) */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/v1/admin/festivals/{festivalId}/tents/available": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List tents available to a festival (admin) */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/v1/admin/festivals/{festivalId}/tents/all": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Add all available tents to a festival (admin)
    ...
    "/v1/admin/festivals/{festivalId}/tents/copy": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Copy tents from another festival (admin)
    ...
    "/v1/admin/festivals/{festivalId}/tents/{tentId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post?: never;
        /**
         * Remove a tent from a festival (admin)
        ...
        head?: never;
        /**
         * Set a tent's beer price at a festival (admin)
         * @description Writes the euro column, the cents column and the canonical drink_type_prices row together. A null price clears all three.
         */
        patch: {
            parameters: {
                query?: never;
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            ...
                            features: {
                                /** @enum {string} */
                                feature: "attendance" | "drinks" | "photos" | "group_joins" | "group_messages" | "photo_reactions" | "photo_comments" | "day_plans" | "crowd_reports" | "friend_requests" | "location_sharing" | "wrapped";
                                users: number;
                                events: number;
                            }[];
                        };
    ...
    "/v1/admin/analytics/activation-funnel": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/admin/analytics/festival-retention": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
