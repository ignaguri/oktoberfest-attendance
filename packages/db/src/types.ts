...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      location_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "location_sessions_user_id_profiles_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "leaderboard";
            referencedColumns: ["user_id"];
      ...
      photo_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "photo_comments_group_id_fkey";
            columns: ["group_id"];
            isOneToOne: false;
            referencedRelation: "groups";
            referencedColumns: ["id"];
      ...
      photo_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "photo_reactions_group_id_fkey";
            columns: ["group_id"];
            isOneToOne: false;
            referencedRelation: "groups";
            referencedColumns: ["id"];
      ...
      tent_crowd_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "tent_crowd_reports_festival_id_fkey";
            columns: ["festival_id"];
            isOneToOne: false;
            referencedRelation: "festivals";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "tent_crowd_reports_tent_id_fkey";
            columns: ["tent_id"];
            isOneToOne: false;
            referencedRelation: "tents";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "tent_crowd_reports_user_id_profiles_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "leaderboard";
            referencedColumns: ["user_id"];
    ...
    Views: {
      activity_feed: {
        Row: {
          ...
          activity_type: Database["public"]["Enums"]["activity_type_enum"] | null;
          avatar_url: string | null;
          festival_id: string | null;
          full_name: string | null;
          user_id: string | null;
    ...
    Enums: {
      ...
      drink_type: "beer" | "radler" | "alcohol_free" | "wine" | "soft_drink" | "other";
      festival_status_enum: "upcoming" | "active" | "ended";
      festival_type_enum: "oktoberfest" | "starkbierfest" | "fruehlingsfest" | "other";
