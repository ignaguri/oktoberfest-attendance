...
export const GLYPH_PATHS: Record<GlyphId, readonly GlyphShape[]> = {
  masskrug: [
    ...
    { d: "M15.2 10 H17.2 A3.2 3.2 0 0 1 17.2 16.4 H15.2 V15 H17.2 A1.8 1.8 0 0 0 17.2 11.4 H15.2 Z", tone: "solid" },
    { d: "M5.6 8 V6.6 A2.1 2.1 0 0 1 8.2 4.3 A2.9 2.9 0 0 1 13.2 4.6 A2.1 2.1 0 0 1 15.4 6.8 V8 Z", tone: "solid" },
  ],
  "sunburst-stein": [
    { d: "M11.3 2 H12.7 L12 4.4 Z", tone: "solid" },
    { d: "M11.3 2 H12.7 L12 4.4 Z", tone: "solid", transform: "rotate(45 12 12)" },
    { d: "M11.3 2 H12.7 L12 4.4 Z", tone: "solid", transform: "rotate(90 12 12)" },
    { d: "M11.3 2 H12.7 L12 4.4 Z", tone: "solid", transform: "rotate(135 12 12)" },
    { d: "M11.3 2 H12.7 L12 4.4 Z", tone: "solid", transform: "rotate(180 12 12)" },
    { d: "M11.3 2 H12.7 L12 4.4 Z", tone: "solid", transform: "rotate(225 12 12)" },
    { d: "M11.3 2 H12.7 L12 4.4 Z", tone: "solid", transform: "rotate(270 12 12)" },
    { d: "M11.3 2 H12.7 L12 4.4 Z", tone: "solid", transform: "rotate(315 12 12)" },
    { d: "M8 9.5 H14 V16.1 A1.8 1.8 0 0 1 12.2 17.9 H9.8 A1.8 1.8 0 0 1 8 16.1 Z", tone: "tint" },
    { d: "M7.6 9.5 V8.5 A1.6 1.6 0 0 1 9.6 7.1 A2.2 2.2 0 0 1 13.2 6.9 A1.6 1.6 0 0 1 14.4 8.5 V9.5 Z", tone: "solid" },
    { d: "M14.2 10.9 H15.6 A2.4 2.4 0 0 1 15.6 15.7 H14.2 V14.5 H15.6 A1.2 1.2 0 0 0 15.6 12.1 H14.2 Z", tone: "solid" },
  ],
  "three-glasses": [
    ...
    { d: "M15.4 8 H19.4 V17.2 A1.6 1.6 0 0 1 17.8 18.8 H17 A1.6 1.6 0 0 1 15.4 17.2 Z", tone: "tint" },
    { d: "M15 6.4 H19.8 V8 H15 Z", tone: "solid" },
    { d: "M18.6 10.6 H19.4 A2.4 2.4 0 0 1 19.4 15.4 H18.6 V14.2 H19.4 A1.2 1.2 0 0 0 19.4 11.8 H18.6 Z", tone: "solid" },
  ],
  "measuring-jug": [
    { d: "M7.7 5.2 H16.3 Q21.1 12 16.3 18.8 H7.7 Q2.9 12 7.7 5.2 Z", tone: "tint" },
    { d: "M5.7 9.4 H18.3 V10.6 H5.7 Z", tone: "solid" },
    { d: "M5.7 13.4 H18.3 V14.6 H5.7 Z", tone: "solid" },
  ],
  "coin-hand": [
