...
import groupInvitationRoute from "./routes/group-invitation.route";
...
// Same reason: /groups/invitations/incoming must not be read as a group id
apiV1.route("/", groupInvitationRoute);
