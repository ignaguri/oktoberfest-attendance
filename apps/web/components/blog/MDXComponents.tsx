...
> = {
  en: {
    text: "Planning your trip? ProstCounter helps you track your beer festival experience, compete with friends, and keep memories of every visit.",
    tryFree: "Try ProstCounter Free",
    download: "Download App",
  },
  de: {
    text: "Planst du deinen Trip? ProstCounter hilft dir, dein Bierfest-Erlebnis zu verfolgen, mit Freunden zu wetteifern und Erinnerungen an jeden Besuch zu bewahren.",
    tryFree: "ProstCounter kostenlos testen",
    download: "App herunterladen",
  },
  es: {
    text: "¿Planificando tu viaje? ProstCounter te ayuda a registrar tu experiencia en festivales de cerveza, competir con amigos y guardar recuerdos de cada visita.",
    tryFree: "Prueba ProstCounter gratis",
  ...
  return (
    <div className="my-8 rounded-xl border border-yellow-200 bg-yellow-50 p-6">
      <div className="flex items-start gap-3">
        ...
        <div>
          {children || <p className="mb-4 text-gray-700">{t.text}</p>}
          <div className="flex flex-wrap gap-3">
            <Button variant="yellow" size="sm" asChild>
              <Link href="/sign-up">{t.tryFree}</Link>
            </Button>
