    ...
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none space-y-6">
        ...
        <section>
          ...
          <p>
            Welcome to ProstCounter (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). This
            privacy policy explains how we collect, use, and protect your information when you use
            our web application for tracking attendance at Volksfests in Munich, Germany.
          </p>
          <p>
        ...
        <section>
          ...
          <h3 className="mb-3 text-xl font-medium">2.1 Information You Provide</h3>
          <ul className="ml-4 list-inside list-disc space-y-2">
            ...
            <li>Photos you choose to upload related to your festival attendance</li>
            <li>Group memberships and competition participation</li>
          </ul>

          <h3 className="mt-6 mb-3 text-xl font-medium">2.2 Information from Social Login</h3>
        ...
        <section>
          ...
          <ul className="ml-4 list-inside list-disc space-y-2">
            ...
            <li>Send push notifications about group activities (with your permission)</li>
        ...
        <section>
          ...
          <h3 className="mt-4 mb-3 text-xl font-medium">4.1 Service Providers</h3>
          ...
          <p>
            We may disclose your information if required by German law, court order, or to protect
        ...
        <section>
          ...
          <p className="mt-4">
            ...
            at any time through your profile settings. This action is immediate and irreversible.
          </p>
        </section>

        <section id="data-deletion">
          <h2 className="mb-4 text-2xl font-semibold">7. How to Delete Your Data</h2>
          <p>
            You can permanently delete your account and all associated data at any time by following
            these steps:
          </p>
          <ol className="mt-4 ml-4 list-inside list-decimal space-y-2">
            <li>Sign in to your ProstCounter account</li>
            <li>
              Go to your <strong>Profile</strong> page (click your avatar in the top navigation)
            </li>
            <li>
            ...
            <li>
              Click <strong>&quot;Yes, Delete My Account&quot;</strong> to confirm
            </li>
          </ol>
          <div className="mt-4 rounded-lg border-x-4 border-red-400 bg-red-50 p-4">
            ...
            <ul className="mt-2 space-y-1 text-sm text-red-700">
              ...
              <li className="ml-4">- Beer consumption records and attendance data</li>
              <li className="ml-4">- Photos and tent visits</li>
              <li className="ml-4">- Group memberships and achievements</li>
              <li className="ml-4">- Profile information and account settings</li>
              <li>• You will be immediately signed out and redirected to the homepage</li>
            </ul>
          </div>
          <p className="mt-4">
        ...
        <section>
          <h2 className="mb-4 text-2xl font-semibold">9. Cookies and Tracking</h2>
          ...
          <p className="mt-4">
            We do not use tracking cookies for advertising or marketing purposes. Google Analytics
            is configured to anonymize IP addresses and respect user privacy.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ProstCounter is designed for adults aged 18 and older who can legally consume alcohol in
            Germany. We do not knowingly collect personal information from children under 18. If you
        ...
        <section>
          ...
          <p>
            Your data may be processed and stored outside of Germany through our service providers
            (Supabase, Google, etc.). These transfers are protected by appropriate safeguards
        ...
        <section>
          ...
          <p>
            ...
            date. Your continued use of ProstCounter after changes become effective constitutes
