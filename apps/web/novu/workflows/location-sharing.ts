...
export const LOCATION_SHARING_WORKFLOW_ID = "location-sharing-notification" as const;
...
export const locationSharingPayloadSchema = z.object({
  ...
  sharerAvatar: z.string().optional().describe("URL of the sharer's avatar image"),
...
export type LocationSharingPayload = z.infer<typeof locationSharingPayloadSchema>;
    ...
    await step.inApp(
      ...
      },
      {
        controlSchema: z.object({
          ...
          body: z
            .string()
            .default("{{sharerName}} {{action}} sharing their live location in {{groupName}}")
    ...
    await step.push(
      ...
      },
      {
        controlSchema: z.object({
          ...
          pushBody: z
            .string()
            .default("{{sharerName}} {{action}} sharing location in {{groupName}}")
