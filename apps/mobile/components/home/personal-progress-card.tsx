...
import { getHeadlineLine, getProgressLines } from "@prostcounter/shared/utils";
 ...
 * feed; social users get the title and one headline line, and a tap opens
 * the same content the solo card shows.
 */
export function PersonalProgressCard() {
  ...
  const headline = getHeadlineLine(lines);
  if (!headline) {
    return null;
  }
