            ...
            <View key={photo.id || `photo-${index}`} className="relative">
              ...
              {!disabled && !isUploading && (
                <Pressable
                  ...
                  className="bg-error-500 absolute -top-2 -right-2 h-6 w-6 items-center justify-center rounded-full"
                >
            ...
            {isUploading ? (
              ...
              !disabled && (
                <Pressable
                  ...
                  className="bg-background-400 absolute -top-2 -right-2 h-6 w-6 items-center justify-center rounded-full"
                >
