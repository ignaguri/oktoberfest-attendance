...
// White check icon for use in filled backgrounds (e.g., checkbox)
const CheckIconWhite = createIcon({
  Root: Svg,
  viewBox: '0 0 24 24',
  path: (
    <>
...
CheckIconWhite.displayName = 'CheckIconWhite';
...
export { CheckIcon, CheckIconWhite, CheckCircleIcon };
