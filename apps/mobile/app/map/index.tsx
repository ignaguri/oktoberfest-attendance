...
export default function MapScreen() {
  ...
  return (
    ...
    >
      {/* Map */}
      <Box className="mx-3 mt-3 mb-2 h-[250px] overflow-hidden rounded-2xl">
        <FriendMap
          showFriends
          showTents
          searchRadius={1000}
      ...
      {currentFestival.mapUrl && (
        <Pressable
          ...
          className="bg-background-100 mx-3 flex-row items-center justify-between rounded-lg px-4 py-3"
