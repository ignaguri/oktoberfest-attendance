-- Feed photo items carry the picture id and a group the viewer shares with the
-- uploader, so tapping a photo in the feed can open the group gallery viewer
-- with its reactions and comments instead of a bare preview.
--
