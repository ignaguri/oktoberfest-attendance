-- Fix tent visits timestamp in update_personal_attendance_with_tents function
-- This function is used for retrospective attendance editing via DetailedAttendanceForm
-- The issue: new tent visits were using now() instead of the attendance date (p_date)
-- The fix: use p_date for new tent visits so they're dated to the attendance date
